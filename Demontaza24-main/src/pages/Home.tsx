...
export default function Home() {
  ...
  return (
    <main className="w-full bg-white text-zinc-900">
      ...
      <section className="py-16 border-t border-b border-zinc-200/60 bg-[#F8F7F4]" aria-label="Pakalpojumi mājā">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto font-sans">
            ...
            <div className="relative bg-white border border-zinc-200 p-6 pb-8 flex flex-col justify-between hover:border-[#FBBF24]/60 transition-colors duration-200 group rounded-[2px] overflow-hidden min-h-[300px]" id="home-service-1">
              ...
              {/* Premium light-colored geometric corner accent */}
              <div className="absolute top-0 right-0 w-16 h-16 pointer-events-none overflow-hidden rounded-tr-[2px]" aria-hidden="true">
                <div className="absolute top-[-25px] right-[-25px] w-14 h-14 bg-gradient-to-bl from-[#FBBF24]/30 via-[#FBBF24]/5 to-transparent rotate-45 transform origin-center" />
                <span className="absolute top-1.5 right-[24px] block w-[1.5px] h-5 bg-[#FBBF24]/60 rotate-45" />
                <span className="absolute top-[24px] right-1.5 block w-5 h-[1.5px] bg-[#FBBF24]/60 rotate-45" />
                <span className="absolute top-2.5 right-2.5 w-1.5 h-1.5 rounded-full bg-[#FBBF24]" />
              </div>
              ...
              <div className="z-10 relative">
                ...
                <p className="text-zinc-600 text-xs sm:text-sm leading-relaxed mb-5 font-sans">
      ...
      <section className="py-16 bg-white border-b border-zinc-200/50" id="kapec-izveleties-mus">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-16 bg-[#F4F3EF] border-b border-zinc-200/50" id="darba-process">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-16 bg-white border-b border-zinc-200/50" id="sertifikati-un-atlaujas">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {PORTFOLIO_HOME.map((project) => (
              <div 
                ...
                className="bg-zinc-50 border border-zinc-200 p-4 rounded-[2px] hover:border-zinc-300 cursor-pointer flex flex-col justify-between group transition-all duration-200 hover:shadow-md"
              >
                <div>
                  <div className="relative aspect-video w-full overflow-hidden border border-zinc-200/60 rounded-[2px] mb-4 bg-zinc-950">
                    <img 
                      ...
                      className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                    />
                    <div className="absolute top-2 left-2 bg-[#FBBF24] text-[#111827] text-[9px] font-mono font-black uppercase tracking-wider px-2.5 py-0.5 rounded-[2px] border border-[#FBBF24]/30 shadow">
                      {project.tag}
                    </div>
                  </div>
      ...
      <section className="relative py-20 bg-cover bg-center bg-no-repeat text-white border-t border-zinc-900 overflow-hidden" 
        ...
        <div className="relative z-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {stats.map((stat, idx) => (
              <div key={idx} className="p-6 bg-black/45 backdrop-blur-sm border border-[#FBBF24] rounded-[2px] shadow-lg hover:bg-zinc-950/80 transition-all duration-150">
      ...
      {/* CONTACT FORM SECTION (Dark structured, high contrast slightly lighter card) */}
      <section id="contact-section-home" className="py-20 bg-[#18181b] border-t border-zinc-800" aria-label="Sazināties formā">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <div className="bg-[#27272a] border border-zinc-800 p-6 sm:p-10 rounded-[2px] shadow-2xl">
