...
export default function Header() {
  ...
  const headerClass = isHome
    ? (isWhiteHeader
        ? "fixed top-0 left-0 right-0 z-50 w-full bg-white shadow-md transition-all duration-150"
    ...
    : "sticky top-0 z-50 w-full bg-white shadow-md transition-all duration-150";
          ...
          <div className="relative">
            ...
            {langDropdownOpen && (
              <div className="absolute right-0 mt-1 w-24 bg-white border border-zinc-200 shadow-md rounded-[2px] py-1 z-50">
                <button
                  onClick={() => handleLangChange("LV")}
                  className="w-full px-2 py-2 text-xs text-left hover:bg-zinc-100 flex items-center gap-1.5 align-middle"
                >
                  <span>🇱🇻</span> LV
                </button>
                <button
      ...
      {mobileMenuOpen && (
        <div className={`md:hidden border-t px-4 py-4 shadow-inner space-y-3 animate-slideIn ${
          ...
          <div className="pt-4 border-t border-zinc-800/10 space-y-2.5 text-center">
            ...
            <a href="mailto:info@demontaza24.eu" className="block text-zinc-400 text-xs py-1 hover:underline transition-colors block">
