...
const SECTIONS_DATA: Section[] = [
  {
    ...
    galleries: [
      ...
      { id: "eku-2", isTemplate: true, title: "Objekts #2", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] },
      { id: "eku-3", isTemplate: true, title: "Objekts #3", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] }
    ]
  },
  {
    id: 2,
    ...
    galleries: [
      ...
      { id: "priv-2", isTemplate: true, title: "Objekts #2", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] },
      { id: "priv-3", isTemplate: true, title: "Objekts #3", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] }
    ]
  },
  {
    id: 3,
    ...
    galleries: [
      ...
      { id: "skun-2", isTemplate: true, title: "Objekts #2", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] },
      { id: "skun-3", isTemplate: true, title: "Objekts #3", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] }
    ]
  },
  {
    id: 5,
    ...
    galleries: [
      ...
      { id: "ind-2", isTemplate: true, title: "Objekts #2", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] },
      { id: "ind-3", isTemplate: true, title: "Objekts #3", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] }
    ]
  },
  {
    id: 6,
    ...
    galleries: [
      ...
      { id: "gruz-2", isTemplate: true, title: "Objekts #2", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] },
      { id: "gruz-3", isTemplate: true, title: "Objekts #3", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] }
    ]
  },
  {
    id: 7,
    ...
    galleries: [
      ...
      { id: "ter-2", isTemplate: true, title: "Objekts #2", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] },
      { id: "ter-3", isTemplate: true, title: "Objekts #3", location: "-", volume: "-", duration: "-", details: "Informācija sekos", images: [] }
    ]
  }
];
              ...
              {activeSection.galleries.map((gallery, gIdx) => {
                if (gallery.isTemplate) {
                  return (
                    <article 
                      key={gallery.id} 
                      className="bg-zinc-50/50 border border-dashed border-zinc-300 p-4 sm:p-6 rounded-[2px] opacity-75 relative overflow-hidden"
                      aria-label={gallery.title}
                    >
                      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start select-none">
                        
                        {/* Left Side: Empty/Skeleton Images */}
                        <div className="md:col-span-6 space-y-3">
                          {/* 1. Large Cover Placeholder */}
                          <div className="relative aspect-[1.25/1] w-full overflow-hidden border border-zinc-200 rounded-[2px] bg-zinc-200/50 flex flex-col items-center justify-center p-4">
                            <Layers className="h-8 w-8 text-zinc-400 mb-2 animate-pulse" />
                          </div>
  
                          {/* 2. Smaller Empty Thumbnails */}
                          <div className="grid grid-cols-5 gap-2">
                            {[1, 2, 3, 4, 5].map((num) => (
                              <div
                                key={num}
                                className="relative aspect-[1.25/1] w-full overflow-hidden border border-zinc-200/60 rounded-[2px] bg-zinc-200/30 flex items-center justify-center"
                              >
                                <span className="text-zinc-400 font-mono text-[9px]">#{num}</span>
                              </div>
                            ))}
                          </div>
                        </div>
                        ...
                        <div className="md:col-span-6 flex flex-col justify-between h-full space-y-4 text-left">
                          <div>
                            ...
                            <div className="border-b border-zinc-200 pb-3 mb-4">
                              <span className="text-[10px] text-zinc-400 font-black uppercase tracking-widest font-mono">
                                Projekta apraksts
                              </span>
                              <h3 className="text-zinc-500 text-base sm:text-lg font-black tracking-tight uppercase leading-tight mt-1">
                                {gallery.title}
                              </h3>
                            </div>
                            ...
                            <div className="space-y-2.5 text-xs text-zinc-500 font-sans">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="font-semibold text-zinc-400 w-16">Vieta:</span>
                                <span className="text-zinc-500">{gallery.location}</span>
                              </div>
                              <div className="flex items-center gap-2">
                                <ClipboardList className="h-4 w-4 text-zinc-300 flex-shrink-0" />
                                <span className="font-semibold text-zinc-400 w-16">Apjoms:</span>
                                <span className="text-zinc-500">{gallery.volume}</span>
                              </div>
                              <div className="flex items-center gap-2">
                                <Clock className="h-4 w-4 text-zinc-300 flex-shrink-0" />
                                <span className="font-semibold text-zinc-400 w-16">Termiņš:</span>
                                <span className="text-zinc-500">{gallery.duration}</span>
                              </div>
                            </div>
  
                            {/* Description Text */}
                            <p className="mt-4 text-xs sm:text-sm text-zinc-400 leading-relaxed font-sans border-t border-zinc-150 pt-3 italic">
                              {gallery.details || "Informācija sekos"}
                            </p>
                          </div>
                          ...
                          <div className="border-t border-zinc-200/50 pt-4 mt-4 flex items-center justify-between text-[11px] text-zinc-400 font-bold font-sans uppercase tracking-wider">
                            <span className="font-semibold text-zinc-400">Projekta statuss</span>
                            <span className="text-zinc-500 font-black tracking-widest bg-zinc-200 px-4 py-1.5 rounded-[1px] text-[10px]">
                              SAGATAVOŠANĀ
                            </span>
                          </div>
                        </div>
                ...
                return (
                  <article 
                    key={gallery.id} 
                    className="bg-zinc-50 border border-zinc-200 p-4 sm:p-6 rounded-[2px] transition-all duration-200 hover:border-zinc-355 hover:shadow-md"
                    aria-label={gallery.title}
                  >
