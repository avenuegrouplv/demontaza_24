        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            >
              ...
              <h3 className="text-white text-base font-extrabold uppercase tracking-wider mb-1.5">Tālruņa numurs</h3>
              <p className="text-zinc-400 text-xs font-sans mb-3">Zvaniet mums tūlītējai tāmes konsultācijai</p>
              <p className="text-[#FBBF24] text-base sm:text-lg font-black tracking-widest group-hover:text-yellow-400">
                +371 26739899
              </p>
            </a>
            ...
            >
              ...
              <h3 className="text-white text-base font-extrabold uppercase tracking-wider mb-1.5">E-pasta adrese</h3>
              <p className="text-zinc-400 text-xs font-sans mb-3">Nosūtiet tehnisko projektu vai bildes</p>
              <p className="text-[#FBBF24] text-base sm:text-lg font-black tracking-normal group-hover:text-yellow-400 break-all">
                info@demontaza24.eu
              </p>
            </a>
