        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-zinc-600 text-sm leading-relaxed">
              Mēs piedāvājam tirgus cenai atbilstošas nomas maksas specializētajajai demontāžas, zemes darbu un transportēšanas tehnikai. Visa mūsu tehnika ir uzturēta teicamā tehniskajā kārtībā, atbilst ekoloģiskajiem standartiem un ir pieejama tūlītējai nomai ar saistošām licencēta operatora pakalpojumu likmēm.
            </p>
          </div>
              ...
              >
                <div>
                  ...
                  <div className="p-4 sm:p-5 space-y-3.5">
                    ...
                    <div className="bg-zinc-50 border border-zinc-150 p-3 rounded-[2px] space-y-1.5">
